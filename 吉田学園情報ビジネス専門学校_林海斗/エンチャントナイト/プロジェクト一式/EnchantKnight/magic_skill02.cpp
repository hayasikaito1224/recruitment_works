...
#define MAGIC_SKILL02_MAZIC_MAX_TIME (200)
#define MAGIC_SKILL02_MAZIC_INTERVAL (20)
...
void C_Magic_Skill02::Update()
{
	...
	else if (m_nTimer % MAGIC_SKILL02_MAZIC_INTERVAL == 0)
	{
		//氷の球を出す
...
C_Magic_Skill02 * C_Magic_Skill02::Create(const D3DXVECTOR3 & pos, const D3DXVECTOR3 & rot)
{
